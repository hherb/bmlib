...
it, so every first-of-month day holds 49,543–90,571 records and every 1
January 212,439–315,282, against a median ordinary day of 4,890. Such a day cannot be
...
those days fetchable. The stride is *not* the defect #96 suspected: `retstart`
