...
``_DATA_ARCHIVE_NAMES``, so the table has to be trustworthy offline. What is
...
class TestCandidates:
    ...
    def test_every_name_bmlib_matches_is_measured(self):
        ...
        matched = _TRIAL_REGISTRY_NAMES | _DATA_ARCHIVE_NAMES
    ...
    def test_a_name_nlm_and_bmlib_both_carry_is_measured_once(self):
        ...
        candidates = sampler._candidates(_TRIAL_REGISTRY_NAMES | _DATA_ARCHIVE_NAMES)
...
class TestTable:
    ...
    def test_a_measured_archive_is_read_as_a_deposition(self, monkeypatch, capsys):
        ...
        assert row.endswith("data deposition")
